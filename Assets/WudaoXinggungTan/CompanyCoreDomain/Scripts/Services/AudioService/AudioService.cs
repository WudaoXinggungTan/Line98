...
namespace WudaoXinggungTan.CompanyCoreDomain.Scripts.Services.AudioService
{
    public class AudioService : MonoBehaviour, IAudioService
    {
        ...
        private bool TryPlayAudioClip(AudioClipType audioClipType, AudioChannelType audioChannel, AudioPlayType audioPlayType, out AudioClip audioClip)
        {
            ...
            {
                MyLogService.LogError($"No audioChannel of name {audioChannel} found");
                return false;
            }
            ...
            MyLogService.LogTopic($"Played Audio {audioClipType} for channel {audioChannel}", LogTopicType.Audio );
            return true;
        }
        ...
        private bool TryGetAudioClip(AudioClipType audioClipType,out AudioClip audioClip)
        {
            ...
            MyLogService.LogError($"No clip of name {audioClipType} found");
            audioClip = null;
            return false;
        }
        ...
        {
            MyLogService.LogTopic("Stop all audio", LogTopicType.Audio );
