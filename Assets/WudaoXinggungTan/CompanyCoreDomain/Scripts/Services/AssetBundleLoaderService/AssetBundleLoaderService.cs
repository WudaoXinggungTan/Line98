...
namespace WudaoXinggungTan.CompanyCoreDomain.Scripts.Services.AssetBundleLoaderService
{
    public class AssetBundleLoaderService : IAssetBundleLoaderService
    {
        ...
        private bool TryLoadAssetBundle(string assetBundlePathName, out AssetBundle assetBundle)
        {
            ...
            if (assetBundle == null)
            {
                MyLogService.LogWarning("Failed to load AssetBundle at path " + assetBundlePathName);
                return false;
            }
        ...
        private bool TryLoadAssetFromBundle<T>(AssetBundle assetbundle, string assetName, out T asset) where T : Object
        {
            ...
            if (asset == null)
            {
                MyLogService.LogWarning("Failed to load Asset " + assetName);
                return false;
            }
        ...
        public AssetBundle LoadAssetBundle(string assetBundlePathName)
        {
            ...
            if (assetBundle == null)
            {
                MyLogService.LogError("Failed to load AssetBundle at path " + assetBundlePathName);
            }
        ...
        public T LoadAssetFromBundle<T>(AssetBundle assetbundle, string assetName) where T : Object
        {
            ...
            if (asset == null)
            {
                MyLogService.LogError("Failed to load Asset " + assetName);
            }
